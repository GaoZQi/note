...
2. 搜索WSL或Ubuntu，选择合适版本下载

    这里选择Ubuntu 20.04 LTS，网络教程还比较丰富，版本也比较新。
    ![2004](assets/image-1.png)

3. 安装完成后，打开Ubuntu，等待初始化

    ??? tip "更换Ubuntu安装路径"
        在运行Ubuntu之前可以在设置应用中修改安装路径，这里默认安装在C盘，可以修改为其他盘符，以免C盘空间不足。
...
### 安装[oh-my-zsh](https://ohmyz.sh/) (可选)

oh-my-zsh是一个开源的、社区驱动的框架，用于管理zsh配置，提供了大量的插件和主题，可以自定义配置。

!!! note "官方wiki"

    在[oh-my-zsh官方wiki](https://github.com/ohmyzsh/ohmyzsh/wiki)中包含相关配置文档。
